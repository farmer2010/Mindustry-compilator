...
#+   шестой уровень - разделение цикла while
#-   седьмой уровень - преобразование if
#+   восьмой уровень - преобразование математических выражений
        ...
        if l[0] == "while":
            ...
            while 1:
                ...
                if bra_count == 0 and lines_level5[j][0] == "}":
                    ...
                    lines_level5[j + 1] = [Token("goto"), Token("cycle_label" + str(ind)), ["__cycle_condition__"]]
                    break
                j += 1
            #
            lines_level5[i] = [Token("cycle_label" + str(ind))]
            #
            ind += 1
        #
        i += 1
                ...
                while len(mathline) > count:
                    ...
                    if mathline[ind] in operations_1_param:
                        ...
                        for i in range(3):
                            mathline.pop(ind - 1)
                        mathline.insert(ind - 1, Token("__autogenerated" + str(var_ind) + "__"))
                    lines_level7.append(["set", Token("num"), Token("__autogenerated" + str(var_ind) + "__"), operation])
                    #
                    mathline2 = []
                    timer = 0
